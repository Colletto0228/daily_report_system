...
<input type= "text" name= "${AttributeConst.REP_TITLE.getValue()}" id= "${AttributeConst.REP_TITLE}" value= "${report.title}" />
<br /><br />

<label for= "${AttributeConst.REP_COUNT.getValue()}">内容</label><br>
